...
func TestActivatedFeatureRouteContracts(t *testing.T) {
	...
	tests := []struct {
		...
		{path: "/api/v1/auth/register", wantMethods: []string{http.MethodPost}},
		{path: "/api/v1/auth/login", wantMethods: []string{http.MethodPost}},
		{path: "/api/v1/me", wantMethods: []string{http.MethodGet, http.MethodPatch}},
		{path: "/api/v1/auth/logout", wantMethods: []string{http.MethodPost}},
		{path: "/api/v1/auth/logout-all", wantMethods: []string{http.MethodPost}},
		{path: "/api/v1/auth/sessions", wantMethods: []string{http.MethodGet}},
		{path: "/api/v1/invitations/accept", wantMethods: []string{http.MethodPost}},
		{path: "/api/v1/workspace-join-requests", wantMethods: []string{http.MethodPost}},
		{path: "/api/v1/workspaces", wantMethods: []string{http.MethodGet, http.MethodPost}},
		{path: "/api/v1/workspaces/workspace-a/dashboard", wantMethods: []string{http.MethodGet}},
		...
		{path: "/api/v1/workspaces/workspace-a/reports/summary", wantMethods: []string{http.MethodGet}},
		{path: "/api/v1/workspaces/workspace-a/audit", wantMethods: []string{http.MethodGet}},
		...
		{path: "/api/v1/workspaces/workspace-a/transactions", wantMethods: []string{http.MethodGet, http.MethodPost}},
		...
		{path: "/api/v1/workspaces/workspace-a/transaction-categories/reorder", wantMethods: []string{http.MethodPost}},
		{path: "/api/v1/workspaces/workspace-a/transaction-categories/1d75077a-ead4-4bbf-a51d-06ae4c58e27f", wantMethods: []string{http.MethodPatch, http.MethodDelete}},
		{path: "/api/v1/workspaces/workspace-a/contacts", wantMethods: []string{http.MethodGet, http.MethodPost}},
		{path: "/api/v1/workspaces/workspace-a/contacts/contact-a", wantMethods: []string{http.MethodGet, http.MethodPatch, http.MethodDelete}},
		{path: "/api/v1/workspaces/workspace-a/saved-transaction-names", wantMethods: []string{http.MethodGet, http.MethodPost}},
		{path: "/api/v1/workspaces/workspace-a/saved-transaction-names/name-a", wantMethods: []string{http.MethodPatch, http.MethodDelete}},
		...
		{path: "/api/v1/workspaces/workspace-a/bills", wantMethods: []string{http.MethodGet}},
		...
		{path: "/api/v1/workspaces/workspace-a/invitations", wantMethods: []string{http.MethodPost}},
		...
		{path: "/api/v1/workspaces/workspace-a/join-code", wantMethods: []string{http.MethodPost}},
		{path: "/api/v1/workspaces/workspace-a/join-requests", wantMethods: []string{http.MethodGet}},
		{path: "/api/v1/workspaces/workspace-a/join-requests/request-a", wantMethods: []string{http.MethodPatch}},
